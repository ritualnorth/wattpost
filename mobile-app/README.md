...
iOS uses APNs. Android uses FCM. The cloud side needs an Apple APNs
auth key (.p8) and a Firebase service-account JSON; both are held
server-side and never committed.
