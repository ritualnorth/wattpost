...
function setStatus(cls, text) {
  ...
  if (tab) {
    ...
    if (cls === "warn") tab.classList.add("nav-alert-warn");
    else if (cls === "err") tab.classList.add("nav-alert-err");
  }
}
...
// inside the broker tunnel (abc123xyz0.wattpost.cloud), which only
