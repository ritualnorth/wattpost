...
```json
{
  ...
  "message": "REST API access requires the Cloud plan. Upgrade at https://app.wattpost.io/account/billing.",
  "upgrade_url": "https://app.wattpost.io/account/billing"
}
```

## Documentation

`/api/docs` on `app.wattpost.io`, a single markdown-rendered page. Examples
